...
namespace model_model_vector_full_spatial_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_model_vector_full_spatial");
    reader.add_event(262, 260, "end", "model_model_vector_full_spatial");
    return reader;
}
...
class model_model_vector_full_spatial
  : public stan::model::model_base_crtp<model_model_vector_full_spatial> {
private:
        int N;
        int N_before;
        int K;
        ...
        int N_after;
public:
    model_model_vector_full_spatial(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_vector_full_spatial_namespace::model_model_vector_full_spatial";
    ...
    ~model_model_vector_full_spatial() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(beta_log<propto__>(scale_spatial_param, 0.01, 0.01));
            ...
            lp_accum__.add(inv_wishart_log<propto__>(theta_vec_cov_matrix, ((1.0 * P) * K), diag_matrix(rep_vector(100, (P * K)))));
            current_statement_begin__ = 123;
            for (int j = 1; j <= J; ++j) {
                current_statement_begin__ = 126;
                lp_accum__.add(multi_normal_log<propto__>(get_base1(get_base1(theta_vec, j, "theta_vec", 1), 1, "theta_vec", 2), rep_vector(0, (P * K)), theta_vec_cov_matrix));
            ...
            lp_accum__.add(inv_wishart_log<propto__>(theta_vec_cov_matrix_no_spatial, ((1.0 * P) * K), diag_matrix(rep_vector(100, (P * K)))));
            current_statement_begin__ = 135;
            lp_accum__.add(multi_normal_log<propto__>(get_base1(theta_vec_no_espatial, 1, "theta_vec_no_espatial", 1), rep_vector(0, (K * P)), theta_vec_cov_matrix_no_spatial));
            current_statement_begin__ = 136;
            lp_accum__.add(multi_normal_log<propto__>(stan::model::rvalue(theta_vec_no_espatial, stan::model::cons_list(stan::model::index_min_max(2, N_before), stan::model::nil_index_list()), "theta_vec_no_espatial"), stan::model::rvalue(theta_vec_no_espatial, stan::model::cons_list(stan::model::index_min_max(1, (N_before - 1)), stan::model::nil_index_list()), "theta_vec_no_espatial"), theta_vec_cov_matrix_no_spatial));
            ...
            for (int t = 1; t <= N_before; ++t) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    stan::model::assign(mu, 
                                stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                elt_multiply(get_base1(pi_mixture, j, "pi_mixture", 1), multiply(transpose(to_matrix(get_base1(get_base1(theta_vec, j, "theta_vec", 1), t, "theta_vec", 2), P, K)), get_base1(X, t, "X", 1))), 
                                "assigning variable mu");
                }
                current_statement_begin__ = 152;
                stan::model::assign(mu, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                            add(multiply(scale_spatial_param, get_base1(mu, t, "mu", 1)), multiply(multiply((1 - scale_spatial_param), transpose(to_matrix(get_base1(theta_vec_no_espatial, t, "theta_vec_no_espatial", 1), P, K))), get_base1(X, t, "X", 1))), 
                            "assigning variable mu");
            }
            current_statement_begin__ = 156;
            lp_accum__.add(inv_wishart_log<propto__>(sigma_kernels, (1.0 * 2), diag_matrix(rep_vector(100, 2))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_vector_full_spatial_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_model_vector_full_spatial";
    }
...
typedef model_model_vector_full_spatial_namespace::model_model_vector_full_spatial stan_model;
#ifndef USING_R
