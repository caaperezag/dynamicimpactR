...
namespace model_model_vector_full_predict_namespace {
using std::istream;
using std::string;
...
class model_model_vector_full_predict
  : public stan::model::model_base_crtp<model_model_vector_full_predict> {
private:
        int N;
        int N_before;
        int K;
        ...
        int N_after;
public:
    model_model_vector_full_predict(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_model_vector_full_predict_namespace::model_model_vector_full_predict";
    ...
    ~model_model_vector_full_predict() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_model_vector_full_predict_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > theta_vec_pred(N, Eigen::Matrix<double, Eigen::Dynamic, 1>((K * P)));
            ...
            size_t theta_vec_pred_k_0_max__ = N;
    ...
    std::string model_name() const {
        return "model_model_vector_full_predict";
    }
...
typedef model_model_vector_full_predict_namespace::model_model_vector_full_predict stan_model;
#ifndef USING_R
